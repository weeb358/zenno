...
class _CategoryGamesScreenState extends State<CategoryGamesScreen> {
  ...
  final List<Map<String, String>> _categoryGames = [
                ...
                Row(
                  children: [
                    ...
                    const Icon(Icons.dashboard,
                        color: Color(0xFF2563EB), size: 24),
                    const Spacer(),
                    const Icon(Icons.menu, color: Color(0xFF2563EB), size: 24),
                  ],
                ),
              ],
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemCount: _categoryGames.length,
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Tapped: ${_categoryGames[index]['name']}',
                                        ),
                                      ),
                                    );
                                  },
