...
class HorrorGamesScreen extends StatefulWidget {
  const HorrorGamesScreen({super.key});

  @override
  State<HorrorGamesScreen> createState() => _HorrorGamesScreenState();
}

class _HorrorGamesScreenState extends State<HorrorGamesScreen> {
