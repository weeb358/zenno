...
class CoOpsGamesScreen extends StatefulWidget {
  const CoOpsGamesScreen({super.key});

  @override
  State<CoOpsGamesScreen> createState() => _CoOpsGamesScreenState();
}

class _CoOpsGamesScreenState extends State<CoOpsGamesScreen> {
